            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa fa-coffee"></i> Pets for Adoption</h4></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li id="reservation" class=" active wow fadeInDown"><a href="index.php"><span class="glyphicon glyphicon-calendar"></span> Adoptions</a></li>
        ...
        <table class="table table-hover table-condensed wow fadeInDown">
            <thead style="background-color:#282828; color:#fff;">
                <tr>
                    ...
                    <th style="text-align:center;"><span class="glyphicon glyphicon-gift"></span>  Pets </th>
...
<div class="modal fade" id="viewModal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	border-bottom: 1px dashed #fff;">
      ...
      <em style="font-size:12px;color:red; margin-left:20px;">Note: Updated Adoption status here</em>
      <div class="modal-footer"> 
        ...
        <button type="submit" class="btn btn-success wow fadeInDown" name="deliver"><i class="glyphicon glyphicon-send"></i> Adopted</button>
      </div>
      </form>
    </div>
  </div>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2024 <a target="_blank" href="#" title="#">Pets & Paws</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
