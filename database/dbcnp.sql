...
INSERT INTO `tblcnp` (`id`, `name`, `description`, `image`, `status`) VALUES
(1, 'Baltimore Oriole', 'The rich, whistling song of the Baltimore Oriole, ', 'images/e.jpg', 'Available'),
(2, 'Maltese', 'A dog breed whoâ€™s gentle and fearless, the Malte', 'images/2.jpg', 'Available'),
(3, 'Bulldog', 'Bulldogs originally were used to drive cattle to m', 'images/3.jpg', 'Available'),
(4, 'Gordon Setter', 'The Gordon Setter, the black avenger of the Highla', 'images/5.jpg', 'Available'),
(5, 'Bedlington Terrier', 'Bedlingtons are lithe, energetic Englishmen. The c', 'images/9.JPG', 'Available');
